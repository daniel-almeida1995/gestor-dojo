...
export const StudentFinancial = () => {
    ...
    return (
        <div className="flex flex-col min-h-screen bg-gray-50 dark:bg-gray-900 font-sans">
            <header className="sticky top-0 z-30 bg-white/95 dark:bg-gray-900/95 backdrop-blur-md px-4 py-3 flex items-center gap-3 border-b border-gray-100 dark:border-gray-800">
                <button onClick={() => navigate(-1)} className="w-10 h-10 flex items-center justify-center rounded-full active:bg-gray-100 dark:active:bg-gray-800 transition-colors">
                    <ArrowLeft size={24} className="text-gray-900 dark:text-white" />
                </button>
                <div className="flex-1">
                    <h1 className="text-lg font-bold text-gray-900 dark:text-white">Financeiro</h1>
            ...
            <main className="flex-1 p-5 pb-24 space-y-6">
                ...
                <div className="grid grid-cols-2 gap-3">
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col gap-1">
                        ...
                        <span className="text-lg font-bold text-gray-900 dark:text-white">R$ {totalPaid.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
                    </div>
                    <div className="bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex flex-col gap-1">
                        ...
                        <span className={`text-lg font-bold ${totalPending > 0 ? 'text-red-600 dark:text-red-400' : 'text-gray-900 dark:text-white'}`}>
                        ...
                        <div className="flex flex-col gap-3">
                            {transactions.map((item) => (
                                <div
                                    ...
                                    className="bg-white dark:bg-gray-800 p-4 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm flex items-center justify-between cursor-pointer active:scale-[0.98] transition-transform hover:border-blue-100 dark:hover:border-blue-900"
                                >
                                    <div className="flex items-center gap-3">
                                        <div className={`w-10 h-10 rounded-xl flex items-center justify-center text-lg font-bold ${item.type === 'product' ? 'bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400' :
                                                item.type === 'seminar' ? 'bg-orange-50 dark:bg-orange-900/30 text-orange-600 dark:text-orange-400' :
                                                    'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400'
                                            }`}>
                                            {item.type === 'product' ? '🥋' : item.type === 'seminar' ? '🎓' : '📅'}
                                        </div>
                                        <div>
                                            <p className="text-sm font-bold text-gray-900 dark:text-white leading-tight">{item.description}</p>
                                    ...
                                    <div className="flex flex-col items-end gap-1">
                                        <span className="text-sm font-bold text-gray-900 dark:text-white">R$ {item.amount.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</span>
            ...
            <div className="fixed bottom-0 left-0 right-0 p-4 bg-white dark:bg-gray-900 border-t border-gray-100 dark:border-gray-800 flex gap-3">
                <button className="flex-1 h-12 bg-gray-100 dark:bg-gray-800 hover:bg-gray-200 dark:hover:bg-gray-700 text-gray-700 dark:text-gray-300 font-bold rounded-xl flex items-center justify-center gap-2 transition-colors">
                    <Download size={18} />
                    Extrato
                </button>
                <button
            ...
            {isNewPaymentOpen && (
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in duration-200">
                    <div className="bg-white dark:bg-gray-800 w-full max-w-sm rounded-3xl p-6 shadow-2xl relative animate-in zoom-in-95 duration-300">
                        ...
                        <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Novo Lançamento</h3>
                        ...
                        <div className="space-y-4">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full h-12 px-4 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:border-primary focus:ring-0 placeholder:text-gray-400"
                            ...
                            <div className="flex gap-3">
                                ...
                                <div className="w-1/3">
                                    ...
                                    <input
                                        ...
                                        className="w-full h-12 px-2 rounded-xl border border-gray-200 dark:border-gray-600 bg-gray-50 dark:bg-gray-700 text-gray-900 dark:text-white focus:border-primary focus:ring-0"
                                    />
                                </div>
                            </div>
                            <div>
                                <label className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase mb-2 block">Tipo</label>
                                <div className="grid grid-cols-3 gap-2">
                                    {(['tuition', 'product', 'seminar'] as const).map(t => (
                                        <button
                                            key={t}
                                            onClick={() => setNewPaymentType(t)}
                                            className={`h-10 rounded-lg text-xs font-bold uppercase transition-colors ${newPaymentType === t ? 'bg-primary text-white' : 'bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-400'}`}
                                        >
                ...
                <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4 animate-in fade-in duration-200">
                    <div className="bg-white dark:bg-gray-800 w-full max-w-sm rounded-3xl p-6 shadow-2xl relative animate-in zoom-in-95 duration-300">
                        ...
                        <div className="text-center mb-6">
                            <div className={`w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-3 ${selectedTransaction.status === 'paid' ? 'bg-green-100 dark:bg-green-900/30 text-green-600 dark:text-green-400' : 'bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400'
                                }`}>
                                <DollarSign size={32} />
                            </div>
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white">{selectedTransaction.description}</h3>
                            <p className="text-2xl font-extrabold text-gray-900 dark:text-white mt-1">R$ {selectedTransaction.amount.toLocaleString('pt-BR', { minimumFractionDigits: 2 })}</p>
                        ...
                        {selectedTransaction.status === 'paid' ? (
                            ...
                            <>
                                <div className="mb-6">
                                    <p className="text-xs font-bold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-3 ml-1">Forma de Pagamento</p>
                                    <div className="grid grid-cols-3 gap-2">
                                        <button
                                            ...
                                            className={`flex flex-col items-center justify-center gap-1 p-3 rounded-xl border transition-all ${paymentMethod === 'pix'
                                                    ...
                                                    : 'bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-gray-500 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-600'
                                                }`}
                                        >
                                            <QrCode size={20} />
